...
function App() {
  ...
  return (
    <AppShell activeTab={activeTab} onTabChange={setActiveTab}>
      ...
      {activeTab === 'calls' && <CallsPage calls={appData.calls} />}
      {activeTab === 'stories' && <StoriesPage stories={appData.stories} />}
      {activeTab === 'explore' && <ExplorePage />}
      {activeTab === 'settings' && appData.user && <SettingsPage user={appData.user} />}
    </AppShell>
  )
}
